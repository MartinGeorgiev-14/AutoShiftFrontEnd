    ...
    return(
        <div className="favorite-filter-container">
            ...
            <div className="flex flex-col lg:gap-2">
                <div className="flex items-center lg:text-lg lg:gap-1">
                ...
                <div className="flex lg:gap-5">
                    ...
                    hover-transition text-white lg:py-1 lg:px-2 rounded-lg" onClick={handleRemoveFilter}>Remove Filter</button>
                    <button className="bg-custom-blue hover:bg-custom-hover-blue cursor-pointer
                    hover-transition text-white lg:py-1 lg:px-2 rounded-lg" onClick={handleSeeListings}>See Listings</button>
                </div>
            </div>
        </div>
    )
